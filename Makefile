...
run:    m_matrix.o m_time_scheme.o m_powermethod.o m_polynom.o m_file_function.o m_adjoint_test.o m_acoustic.o m_adjoint.o m_fwi.o  m_init_application.o main.o
	$(FC) $(CFLAGS) $^ -o $@  $(LDFLAG)
