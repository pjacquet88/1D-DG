...
module m_polynom
  ...
  public  :: init_polynom,free_polynom,                                         &
  ...
  private :: D0_sparse,D1_sparse,                                               &
             ...
             free_basis_b,free_basis_l,                                         &
             free_L2B,free_B2L,free_derive,                                     &
             C,b_basis,l_basis
contains


  subroutine init_polynom(order)
    implicit none
  ...
  end subroutine init_polynom

  
  subroutine free_polynom()
    implicit none
    call free_basis_b
    call free_basis_l
    call free_B2L
